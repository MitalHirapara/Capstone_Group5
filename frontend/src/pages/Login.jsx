  ...
  return (
    <div>
      <div class="relative overflow-hidden">
                  ...
                  <form onSubmit={handleSubmit}>
                    <div class="grid gap-y-4">
                      <div>
                        <label
                          for="email"
                          class="block text-sm mb-2 text-gray-900 dark:text-white"
                        >
                          Username or Email
                        </label>
                        <div class="relative">
                      ...
                      <div class="flex items-center">
                        ...
                        <div class="flex justify-between items-center ms-3">
                          ...
                          <a
                            class="inline-flex items-end  gap-x-1 text-sm text-blue-600 decoration-2 hover:underline focus:outline-none focus:underline font-medium dark:text-blue-500"
                    ...
                    <a
                      class="mt-4 text-blue-600 decoration-2 hover:underline focus:outline-none focus:underline font-medium dark:text-blue-500"
                      href="/"
                    >
                      Back
                    </a>
        ...
        <div class="hidden md:block md:absolute md:top-0 md:start-1/2 md:end-0 h-full bg-[url('../public/login.svg')] bg-no-repeat bg-center bg-cover bg-[length:70%] md:bg-[length:80%]"></div>
      </div>
    </div>
  );
}
