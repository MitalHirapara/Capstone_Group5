              ...
              <form onSubmit={handleSubmit} method="POST">
                <div class="lg:max-w-lg lg:mx-auto lg:me-0 ms-auto">
                  <div class="p-4 sm:p-7 flex flex-col bg-white rounded-2xl shadow-lg dark:bg-neutral-900">
                    ...
                    <div class="mt-5">
                      ...
                      <div class="mt-5 flex items-center">
                        ...
                        <div class="ms-3">
                          <label
                            for="remember-me"
                            class="text-sm dark:text-white text-gray-900"
                          >
                            I accept the{" "}
                            <a
                              class="text-blue-600 decoration-2 hover:underline focus:outline-none focus:underline font-medium dark:text-blue-500"
                    ...
                    <a
                      class="mt-3 text-blue-600 decoration-2 hover:underline focus:outline-none focus:underline font-medium dark:text-blue-500"
                      href="/"
                    >
                      Back
                    </a>
